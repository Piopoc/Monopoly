...
class Player{
    public:
        ...
        bool has_this_money(int value); //controllo se ha abbastanza denaro da spendere
        ...
        bool pc_buys(int value); //controlla se puo e sceglie se comprare p=25% computer
